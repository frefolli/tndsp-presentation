    ...
    \begin{columns}
      ...
      \begin{column}{0.3\textwidth}
        \begin{tabular}{|l|c|c|c|}
          ...
          Route & $Q_{max}$ & $f$ & $ht$ \\
          \hline
          \textbf{$R_{1}$} & 519.1 & 10.51 & 5.71 \\
          \hline
          \textbf{$R_{2}$} & 392.02 & 8.42 & 7.12 \\
          \hline
          \textbf{$R_{3}$} & 279.65 & 6.78 & 8.85 \\
          \hline
          \textbf{$R_{4}$} & 441.57 & 9.4 & 6.38 \\
          \hline
          \textbf{$R_{5}$} & 392.32 & 9.0 & 6.66 \\
          \hline
          \textbf{$R_{6}$} & 124.08 & 3.72 & 16.12 \\
          \hline
          \textbf{$R_{7}$} & 710.97 & 13.0 & 4.62 \\
          \hline
          \textbf{$R_{8}$} & 599.38 & 11.9 & 5.04 \\
          \hline
          \textbf{$R_{9}$} & 157.14 & 4.27 & 14.05 \\
          \hline
          \textbf{$R_{10}$} & 142.6 & 4.34 & 13.82 \\
          \hline
        \end{tabular}
      \end{column}
