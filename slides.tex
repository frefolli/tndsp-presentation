...
%% TODO: Rewrite this slide to only explain the components without using a formula
\begin{frame}
...
\begin{frame}
  ...
  \begin{block}{Definition}
    \begin{itemize}
      ...
      \item Each path is contained exactly once and has an associated ID.
...
%% Maybe remove time complexity and say it aloud at presentation time
\begin{frame}
...
\begin{frame}
  ...
  \begin{alertblock}{Individual's Feasibility Criteria}
    \begin{itemize}
      ...
      \item Each individual shall contain at most one occurrence of each route
    \end{itemize}
  \end{alertblock}
...
%% TODO: Summarize in other slides and/or remove
\begin{frame}
...
%% TODO: Summarize the concept without using formulas
\begin{frame}
...
%% TODO: Simplify the slide to show only the essentials
\begin{frame}
